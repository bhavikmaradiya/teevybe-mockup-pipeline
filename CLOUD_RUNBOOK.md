...
- a configured Drive delivery root with folder-create, JPEG-upload, and readback actions, evaluated under the cloud storage-quota policy in `drive-publish.md` (quota-reporting access is optional, not a required capability); and
